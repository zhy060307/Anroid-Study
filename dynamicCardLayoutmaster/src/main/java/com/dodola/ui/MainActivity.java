...
import static com.dodola.model.DuitangInfo.TYPE_1_1;
import static com.dodola.model.DuitangInfo.TYPE_1_2;
import static com.dodola.model.DuitangInfo.TYPE_1_3;
import static com.dodola.model.DuitangInfo.TYPE_2_1;
import static com.dodola.model.DuitangInfo.TYPE_2_2;
import static com.dodola.model.DuitangInfo.TYPE_2_3;
import static com.dodola.model.DuitangInfo.TYPE_3_1;
import static com.dodola.model.DuitangInfo.TYPE_3_2;
import static com.dodola.model.DuitangInfo.TYPE_3_3;
...
public class MainActivity extends Activity implements OnScrollListener {
    ...
    private int rowCountPerScreen = 1;
    private int cols = 3;// 当前总列数
...
//                info.setIsrc("https://www.baidu.com/img/bd_logo1.png");
//                duitangs.add(new DuitangInfo(TYPE_2_2));
//                duitangs.add(new DuitangInfo(TYPE_1_1));
//                duitangs.add(new DuitangInfo(TYPE_1_1));
//                duitangs.add(new DuitangInfo(TYPE_3_1));
...
//                duitangs.add(new DuitangInfo(TYPE_1_1));
                ...
                duitangs.add(new DuitangInfo(TYPE_1_3));
                duitangs.add(new DuitangInfo(TYPE_2_3));
                duitangs.add(new DuitangInfo(TYPE_2_2));
                return duitangs;
            } catch (Exception e) {
                e.printStackTrace();
            ...
            if (result != null) {
                ...
                for (int i = 0; i < result.size(); i++) {
                    ...
                    switch (info.getType()) {
                        ...
                        case TYPE_2_3:
                            params = new RelativeLayout.LayoutParams(
                                    columnWidth * 2, itemHeight * 3);
                            break;

                        case TYPE_3_1:
                            params = new RelativeLayout.LayoutParams(
                                    columnWidth * 3, itemHeight);
                            break;
                        case TYPE_3_2:
                            params = new RelativeLayout.LayoutParams(
                                    columnWidth * 3, itemHeight * 2);
                            break;
                        case TYPE_3_3:
                            params = new RelativeLayout.LayoutParams(
                                    columnWidth * 3, itemHeight * 3);
                            break;
                        default:
                            params = new RelativeLayout.LayoutParams(
                                    columnWidth, itemHeight);
